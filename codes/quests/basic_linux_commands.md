...
Mode                 LastWriteTime         Length Name
----                 -------------         ------ ----
-a----      2025-07-15   오후 3:45             40 hello.txt
```
- images 폴더에 photo1.jpg, photo2.png 빈 파일을 생성하세요
```shell
PS C:\Develops\Quests\powershell_practice\images> "내용" > photo1.jpg
PS C:\Develops\Quests\powershell_practice\images> "내용" > photo2.png
...
Mode                 LastWriteTime         Length Name
----                 -------------         ------ ----
-a----      2025-07-15   오후 3:47             10 photo1.jpg
-a----      2025-07-15   오후 3:48             10 photo2.png
```
...
Mode                 LastWriteTime         Length Name
----                 -------------         ------ ----
-a----      2025-07-15   오후 3:53              6 test.txt
```
...
----                 -------------         ------ ----
-a----      2025-07-15   오후 3:45             40 hello.txt
-a----      2025-07-15   오후 3:56              6 test.txt
...
----                 -------------         ------ ----
-a----      2025-07-15   오후 3:45             40 hello.txt
-a----      2025-07-15   오후 3:56              6 moved_file.txt
...
Mode                 LastWriteTime         Length Name
----                 -------------         ------ ----
d-----      2025-07-15   오후 3:52                backup
d-----      2025-07-15   오후 3:57                documents
d-----      2025-07-15   오후 3:58                images
d-----      2025-07-15   오후 3:56                temp
...
d-----      2025-07-15   오후 3:57                documents
d-----      2025-07-15   오후 3:58                images
d-----      2025-07-15   오후 3:56                temporary
```
...
----                 -------------         ------ ----
d-----      2025-07-15   오후 3:52                backup
d-----      2025-07-15   오후 4:10                documents
d-----      2025-07-15   오후 4:10                images
d-----      2025-07-15   오후 3:56                temporary
...
확인
C:\Develops\Quests\powershell_practice\backup의 항목에는 하위 항목이
있으며 Recurse 매개 변수를 지정하지 않았습니다. 계속하면 해당 항목과
...
PS C:\Develops\Quests\powershell_practice\my_project\docs> cat readme.txt
This is my project
PS C:\Develops\Quests\powershell_practice\my_project\docs>
```
### 문제 5-2: 파일 정리
...
Mode                 LastWriteTime         Length Name
----                 -------------         ------ ----
-a----      2025-07-15   오후 4:19             46 main.py
```
...
PS C:\Develops\Quests\powershell_practice\my_project\docs> mv readme.txt project_info.txt                                                       PS C:\Develops\Quests\powershell_practice\my_project\docs> ls
...
Mode                 LastWriteTime         Length Name
----                 -------------         ------ ----
-a----      2025-07-15   오후 4:19             42 project_info.txt
```
- tests 폴더를 삭제하세요
```shell
...
PS C:\Develops\Quests\powershell_practice\my_project\docs> cat project_info.txt
This is my project
PS C:\Develops\Quests\powershell_practice\my_project\docs> cd C:\Develops\Quests\powershell_practice\my_project/src
PS C:\Develops\Quests\powershell_practice\my_project\src> ls
