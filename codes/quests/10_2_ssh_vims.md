...
mkdir -p ~/vim_crud_practice_2/{comp1,comp2,comp3} &&\
cd ~/vim_crud_practice_2/comp1 &&\
echo -e "Apple\nBanana\nCherry" > fruits.txt &&\
cd ../comp2 &&\
...
✅ 명령어 힌트: `/검색`, `yy`, `p`, `:wq`
```shell
[seungjae@192.168.0.43 ~/vim_crud_practice_2/comp2]$ cat todo.txt
1. Clean the house
2. Buy groceries
3. Call Mom
3. Call Mom
...
✅ 명령어 힌트: `G`, `o`, `i`, `ESC`, `:wq`
```shell
[seungjae@192.168.0.43 ~/vim_crud_practice_2/comp1]$ cat fruits.txt 
Apple
Banana
Cherry
Durian
...
✅ 명령어 힌트: `:%s///`, `yy`, `p`, `:wq`
```shell
[seungjae@192.168.0.43 ~/vim_crud_practice_2/comp3]$ cat users.csv 
Name,Email
...
[seungjae@192.168.0.43 ~/vim_crud_practice_2/comp3]$ cat users.csv 
Name,Email
John Smith,john.doe@google.com
John Smith,john.doe@google.com
John Smith,john.doe@google.com
John Smith,john.doe@google.com
```
